...
import org.springdata.cql.support.exception.CassandraAuthenticationException;
import org.springdata.cql.support.exception.CassandraConnectionFailureException;
import org.springdata.cql.support.exception.CassandraInsufficientReplicasAvailableException;
import org.springdata.cql.support.exception.CassandraInternalException;
import org.springdata.cql.support.exception.CassandraInvalidConfigurationInQueryException;
import org.springdata.cql.support.exception.CassandraInvalidQueryException;
import org.springdata.cql.support.exception.CassandraKeyspaceExistsException;
import org.springdata.cql.support.exception.CassandraQuerySyntaxException;
import org.springdata.cql.support.exception.CassandraReadTimeoutException;
import org.springdata.cql.support.exception.CassandraTableExistsException;
import org.springdata.cql.support.exception.CassandraTraceRetrievalException;
import org.springdata.cql.support.exception.CassandraTruncateException;
import org.springdata.cql.support.exception.CassandraTypeMismatchException;
import org.springdata.cql.support.exception.CassandraUnauthorizedException;
import org.springdata.cql.support.exception.CassandraUncategorizedException;
import org.springdata.cql.support.exception.CassandraWriteTimeoutException;
